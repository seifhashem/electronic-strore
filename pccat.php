       ...
       <div class="logo">
        ...
        <div class="small-container">
            ...
            <div class="navigation-manual">
             ...
             <div class="row row-2">
                <h2>Computers, Components & Accessories</h2>
            ...
            $res=mysqli_query($link,"select * from product inner join subcategory on product.subcategory = subcategory.subcat_id inner join category on subcategory.CategoryId = category.CategoryId where category.CategoryId =1023");
            while($row=mysqli_fetch_array($res))
            {
            ?>
                    <form action="manage_cart.php">
                    <div class="col-4">
                    <img src="../htdocs/<?php echo $row["Productimage"]; ?>" name="Productimage">
                    <h4 name="ProductName"> <?php echo $row["ProductName"]; ?></h4>
                  
                    <p name="ProductPrice"> <?php echo $row["ProductPrice"]; ?> EGP</p>
