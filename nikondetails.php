    ...
    <body>
       ...
       <div class="logo">
        ...
        <div class="small container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="images/nkl-25468_1.jpg" width="70%" id="ProductImg">
                      <div class="small-img-row">   
                <div class="small-img-col">
                    <img src="images/nkl-25468_1.jpg" width="70%" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/nikon2.jpg" width="70%" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/nikon3.jpg" width="70%" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/nikon4.jpg" width="70%" class="small-img">
                </div>
                </div>    
                ...
                <div class="col-2">
                    ...
                    <br>
                    <p>Nikons D7000 features a 16.2 MP DX-format CMOS sensor, 6 fps continuous shooting and breathtaking Full 1080p HD Movies with full time autofocus</p>
                </div>
            </div>
        </div>
