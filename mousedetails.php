    ...
    <body>
       ...
       <div class="logo">
        ...
        <div class="small container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="images/mouse1.jpg" width="45%" id="ProductImg">
                      <div class="small-img-row">   
                <div class="small-img-col">
                    <img src="images/mouse1.jpg" width="70%" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/mouse2.jpg" width="30%" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/mouse4.jpg" width="65%" class="small-img">
                </div>
                ...
                <div class="col-2">
                    ...
                    <h1>
                        Glorious Model O Gaming Mouse Matte Black </h1>
                    <h4>450.000 EGP</h4>
                    ...
                    <br>
                    <p>SIZE & STYLE: Ambidextrous ultralight weight gaming mouse ideal for [MEDIUM to LARGE] hands. Built for speed, control, and comfort.
                        ULTRA FLEXIBLE CABLE: Our Braided 'Ascended' Cord is so light it produces a drag-free wireless feel.
                        MOUSE FEET: Our Glorious Skates are 100% pure Virgin PTFE that will glide like blades on ice</p>
                </div>
            </div>
        </div>
