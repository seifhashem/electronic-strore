       ...
       <div class="logo">
        ...
        <div class="small-container">
            ...
            <div class="navigation-manual">
             ...
             <div class="row row-2">
                <h2>Mobile Phones & Communication Products</h2>
            ...
            $res=mysqli_query($link,"select * from product inner join subcategory on product.subcategory = subcategory.subcat_id inner join category on subcategory.CategoryId = category.CategoryId where category.CategoryId =123");
