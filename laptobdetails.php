    ...
    <body>
       ...
       <div class="logo">
        ...
        <div class="small container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="images/mac1.jpg" width="75%" id="ProductImg">
                      <div class="small-img-row">   
                <div class="small-img-col">
                    <img src="images/mac1.jpg" width="70%" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/mac2.jpg" width="70%" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/mac3.jpg" width="60%" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/mac4.jpg" width="55%" class="small-img">
                </div>
                </div>    
                ...
                <div class="col-2">
                    ...
                    <h1>
                        Apple MacBook Pro M1 Max (2021) </h1>
                    <h4>40.000 EGP</h4>
                    ...
                    <br>
                    <p>The new MacBook Pro delivers game-changing performance for pros. With the powerful M1 Pro chip to power through your work while enjoying incredible battery life. And with a 16-inch Liquid Retina XDR display, MacBook Pro pushes the envelope. Space Grey 32GB/1TB (MK1A3FN/A-QWERTY)</p>
                </div>
            </div>
        </div>
